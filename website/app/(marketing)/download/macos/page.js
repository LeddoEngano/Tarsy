...
const DOWNLOAD_URL =
  `${process.env.NEXT_PUBLIC_SUPABASE_URL || "https://xtblbghhlkroskzljqcl.supabase.co"}/storage/v1/object/public/tarsy-releases/Tarsy-1.1.1.dmg`;
              ...
              <div>
                ...
                <div className="mt-3 space-y-1.5">
                  <p className="text-xs text-taupe">
                    ...
                    <span className="text-cream/80">1.1.1</span>
                  </p>
                  <p className="text-xs text-taupe">
