...
```
                        ...
                        │                                                  │
                        │   ┌────────────┐ ┌──────────┐ ┌──────────────┐  │
                        │   │  H.264     │ │  AI Chat  │ │  Git Safety  │  │
                        │   │  Stream    │ │  + Voice  │ │  Net         │  │
                        │   └────────────┘ └──────────┘ └──────────────┘  │
                        │   ┌────────────┐ ┌──────────┐ ┌──────────────┐  │
                        │   │  File      │ │  Dev      │ │  MCP         │  │
                        │   │  Explorer  │ │  Browser  │ │  Store       │  │
                        │   └────────────┘ └──────────┘ └──────────────┘  │
                        │                                                  │
                        └──────────────────────┬───────────────────────────┘
                                               │
                              ┌─────────────────┼─────────────────┐
                              │                 │                 │
                         Smart Connect     LAN :8642        Relay wss://
                        (auto-fallback)        │                 │
                              │                │                 │
                              │       ┌────────┘       ┌─────────┘
                              │       │                │
                        ...
                        │       │          │          │            │        │
                        │   ┌───┴───┐  ┌───┴───┐  ┌──┴────┐  ┌───┴────┐  │
                        │   │Screen │  │  AI   │  │Remote │  │  Dev   │  │
                        │   │Capture│  │Engines│  │ Input │  │Services│  │
                        │   ├───────┤  ├───────┤  ├───────┤  ├────────┤  │
                        │   │ SCKit │  │Claude │  │CGEvent│  │  Git   │  │
                        │   │ H.264 │  │Gemini │  │  idb  │  │ Files  │  │
                        │   │ 30fps │  │ Codex │  │  Sim  │  │  MCP   │  │
                        │   │  6Mb  │  │ Aider │  │       │  │  Sudo  │  │
                        │   └───────┘  └───────┘  └───────┘  └────────┘  │
                        │                                                  │
                        ...
                        │               🗄  Supabase                       │
                        │                                                  │
                        │   Auth ──── Database ──── Realtime ──── Edge Fn  │
                        │    │           │             │             │      │
                        │   Apple    machines       live          send-push │
                        │   GitHub   workspaces    updates       send-email │
                        │   Email    profiles        RLS                   │
                        │            agent_tasks                           │
                        │                                                  │
                        └──────────────────────────────────────────────────┘
